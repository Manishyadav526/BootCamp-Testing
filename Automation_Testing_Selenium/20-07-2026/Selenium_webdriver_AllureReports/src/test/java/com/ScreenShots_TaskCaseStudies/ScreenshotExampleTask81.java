package com.ScreenShots_TaskCaseStudies;
...
public class ScreenshotExampleTask81 {
    ...
    public void PurchaseProduct() throws Exception {
        ...
        driver.findElement(By.id("loginusername")).sendKeys("manishyadav92124@gmail.com");
        driver.findElement(By.id("loginpassword")).sendKeys("8816077162");
