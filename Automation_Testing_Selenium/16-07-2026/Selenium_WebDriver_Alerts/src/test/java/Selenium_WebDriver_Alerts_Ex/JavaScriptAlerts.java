package Selenium_WebDriver_Alerts_Ex;
...
//I want my webdriver to be abstract which is in helper.java
public class JavaScriptAlerts {
	...
	public void TestPopups() throws Exception {
		...
		//driver.switchTo().alert().sendKeys("Hello Manish Yadav");
		//Thread.sleep(1000);
	   // driver.switchTo().alert().accept();
	    Alert alert4 = driver.switchTo().alert();
	    alert4.sendKeys("Hello Manish Yadav");
	    Thread.sleep(8000);
	    alert4.accept();
	    
	    String result4=driver.findElement(By.cssSelector("#result")).getText();
		System.out.println(result4);
		Assert.assertEquals("You entered: Hello Manish Yadav", result4);
